...
e
    : e '+' e
        { $$ = (typeof $1 === 'string' || (typeof $1 === 'object' && $1._returnType === 'string')) || (typeof $3 === 'string' || (typeof $3 === 'object' && $3._returnType === 'string')) ?{"function": "concat",_returnType:"string","textA": removeHtmlTag($1),"textB": removeHtmlTag($3)}: {function: 'calculate', _returnType:'number', items: [{operator:"+"},$1, $3]}}    
    | e '^' e 
        { $$ =  {
